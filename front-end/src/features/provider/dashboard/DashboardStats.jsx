...
const DashboardStats = ({ bookings }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10 items-center text-center">
      {stats.map((stat, i) => (
        <motion.div 
          key={i}
          ...
          className={`bg-white p-6 rounded-xl shadow-sm border-l-4 ${stat.color} design-bg `}
        >
